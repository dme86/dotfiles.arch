...
beautiful.init(gears.filesystem.get_configuration_dir() .. "/themes/dme86/theme.lua")
beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "dme86"))
--local theme_path = string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "dme86")
...
mylauncher = awful.widget.launcher({ image = "/home/dan/.config/awesome/themes/dme86/arch_logo_64.png",
                                     menu = mymainmenu })
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox [add transparency]
    s.mywibox = awful.wibar({ position = "top", screen = s, bg = beautiful.bg_normal .. "93", fg = beautiful.fg_normal .. "90"})
